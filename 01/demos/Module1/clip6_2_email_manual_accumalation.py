# Simple Email Processing Pipeline — Manual Log Accumulation
...
def classify_email(state: EmailState):
    ...
    return {"classification": classification, "log": state["log"] + ["Classified email"]}
...
def generate_response(state: EmailState):
    ...
    return {"response": response, "log": state["log"] +["Generated response"]}
